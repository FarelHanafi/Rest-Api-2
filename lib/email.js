    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Selamat Datang Di Rest-APIs RellXyz</h3>
            <p>
...
Jika Kamu Memiliki Masalah, Silahkan Hubungin Saya Via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=62881026950162">WhatsApp</a></span></span>
            <span style="display: block;"><br>By,<br>RellXyz</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"RellXyz" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api RellXyz`,
        html: inboxGmail,
      };
