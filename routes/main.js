...
router.get('/tes', isAuthenticated, async(req, res) => {
  let getkey = await getApikey(req.user.id)
  let { apikey } = getkey
  res.render('tes', {
    apikey,
...
// ALL FEATURE
router.get('/ai', isAuthenticated, async(req, res) => {
  let getkey = await getApikey(req.user.id)
  let { apikey } = getkey
  res.render('ai', {
    apikey,
...
router.get('/animanga', isAuthenticated, async(req, res) => {
  let getkey = await getApikey(req.user.id)
  let { apikey } = getkey
  res.render('animanga', {
    apikey,
...
router.get('/textpro', isAuthenticated, async(req, res) => {
  let getkey = await getApikey(req.user.id)
  let { apikey } = getkey
  res.render('textpro', {
    apikey,
...
router.get('/photooxy', isAuthenticated, async(req, res) => {
  let getkey = await getApikey(req.user.id)
  let { apikey } = getkey
  res.render('photooxy', {
    apikey,
...
router.get('/canvas', isAuthenticated, async(req, res) => {
  let getkey = await getApikey(req.user.id)
  let { apikey } = getkey
  res.render('canvas', {
    apikey,
...
router.get('/maker', isAuthenticated, async(req, res) => {
  let getkey = await getApikey(req.user.id)
  let { apikey } = getkey
  res.render('maker', {
    apikey,
...
router.get('/stalking', isAuthenticated, async(req, res) => {
  let getkey = await getApikey(req.user.id)
  let { apikey } = getkey
  res.render('stalking', {
    apikey,
...
router.get('/other', isAuthenticated, async(req, res) => {
  let getkey = await getApikey(req.user.id)
  let { apikey } = getkey
  res.render('other', {
    apikey,
